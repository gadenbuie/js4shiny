...
'
  ...
  expect_equal(res_from_yaml[[2]], list(path = "bootstrap@3.3.7/dist/css/bootstrap.min.css", where = "head", type = "css"))
  expect_equal(res_from_yaml[[3]], list(path = "script-head.js", where = "head", type = "javascript"))
  expect_equal(res_from_yaml[[4]], list(path = "script-before.js", where = "before", type = "javascript"))
