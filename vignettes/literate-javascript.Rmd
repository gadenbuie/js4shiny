...
so the result of one chunk aren't necessarily available for later code.
I'll expand on this briefly in the next section.
...
<p><button type="button" id="click-me" value=0>Click Me</button></p>
...
If you want to visualize or use JSON-formatted data in your document,
